...
void doSimultaneousV2MassFit(int cLow = 40, int cHigh = 80,
                     double ptLow = 15.0, double ptHigh = 50.0,
                     double yLow = 0.0, double yHigh=2.4, float ctau=0.025, double muPt = 0.0,
                      float massLow = 2.75, float massHigh =3.45, bool dimusign=true, int ibkg_vn_sel = fpol2){
  setTDRStyle();
